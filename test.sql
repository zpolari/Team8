/*
 ...
 Source Schema         : bookTypeInfo

 Target Server Type    : MySQL
 Target Server Version : 50562
 File Encoding         : 65001

 Date: 12/12/2020 18:24:47
*/
...
CREATE TABLE `CTC`  (
  ...
  `ClassName` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `CourseName` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `Secretary`  (
  ...
  `Accont` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '账户登录名',
  `Password` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '账户密码',
  `Name` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '秘书名称',
  `Age` int(11) NULL DEFAULT NULL COMMENT '秘书年龄',
  `Telephone` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '电话号码',
...
CREATE TABLE `Teacher`  (
  `UnionID` int(11) NOT NULL COMMENT '全局唯一ID',
  `Accont` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '账户登录名',
...
CREATE TABLE `TechBook`  (
  ...
  `Cname` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '教材名称',
...
INSERT INTO `TechBook` VALUES ('203', 'JSP应用开发技术', '柳永坡', '普通教材', '人民邮电出版社	', '2000-1-2');
